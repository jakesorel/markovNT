...
def dts_matrix_dynamic(s_mat_flat,t,D_mat_init,D_mat_fin,t_change):
    ...
    is_changed_expanded = np.expand_dims(np.expand_dims(is_changed,1),2)
...
class Markov_fit:
    ...
    def fit(self):
        ...
        def get_cost(sP,give_cost_decomp=False):
            ...
            if give_cost_decomp:
                return cost, cost_dynamic,cost+cost_dynamic
            else:
                return cost + cost_dynamic
